...
import { ABOUT_ROUTE, AUTH_ROUTE, CART_ROUTE, CATALOG_ROUTE, CONTACT_ROUTE, HOME_PAGE, PRODUCT_PAGE, PRODUCT_ROUTE, REGISTRATION_ROUTE, SHOP_ROUTE, SUBCATALOG_ROUTE } from './utils';
...
function App() {
  return (
    ...
    <Routes>
          ...
          <Route   path={HOME_PAGE} key={HOME_PAGE} element={<Home_page/>}/>
